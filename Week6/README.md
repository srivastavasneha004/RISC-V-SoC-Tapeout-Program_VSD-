...
cd OpenLane
sudo docker run -it --rm -v /home/desktop/VLSI/openlane_working_dir/openlane:/openLANE_flow \
  -v /home/desktop/VLSI/openlane_working_dir/openlane/pdks:/home/desktop/VLSI/openlane_working_dir/openlane/pdks \
  -e PDK_ROOT=/home/desktop/VLSI/openlane_working_dir/openlane/pdks -u 0:0 efabless/openlane:v0.15
...
magic -T /home/desktop/VLSI/openlane_working_dir/pdks/sky130A/libs.tech/magic/sky130A.tech \
...
*LEF file generation command executed - creates abstract view of the cell for place and route tools*
...
*Contents of sky130_vsdinv.lef showing MACRO definition, pin locations (A, Y, VPWR, VGND), and metal layer obstructions*
...
*Directory listing confirming sky130_vsdinv.lef is now in the src folder*
...
*Detailed view of all library files available in src directory*
...
*Updated config.tcl showing new library paths and EXTRA_LEFS variable to include custom cell*
...
*Design successfully prepared with updated configuration values*
...
*Commands to add custom LEF files to the merged LEF used by OpenLane*
...
*Statistics showing number of sky130_vsdinv instances used in the synthesized netlist*
...
*Synthesis successful showing WNS (Worst Negative Slack) and TNS (Total Negative Slack) - both indicate timing violations*
...
*Setting synthesis parameters for aggressive timing optimization - DELAY 3 strategy and cell sizing enabled*
...
*Post-optimization synthesis showing reduced slack values - timing improved significantly*
...
*run_floorplan command failed - need to use individual floorplan steps as workaround*
...
*Floorplan completed successfully using init_floorplan, place_io, and tap_decap_or commands sequentially*
...
*Placement stage executing - global and detailed placement with overflow optimization*
...
*Command to open placement DEF file in Magic for visualization*

**📸 Placement View in Magic**

![image](Images/day4_sec4_magic_placement_view.png)

*Complete placement layout showing all standard cells placed in rows*
...
*STA configuration file specifying liberty files, verilog netlist, and SDC constraints for timing analysis*

**Configuration Contents:**
```tcl
set_cmd units -time ns -capacitance pF -current mA -voltage V -resistance kOhm -distance um
read_liberty -max /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/src/sky130_fd_sc_hd__slow.lib
read_liberty -min /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/src/sky130_fd_sc_hd__fast.lib
read_verilog /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/runs/30-10_15-28/results/synthesis/picorv32a.synthesis.v
link_design picorv32a
read_sdc /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/src/my_base.sdc
...
*SDC (Synopsys Design Constraints) file defining clock period, input/output delays, and load capacitances*
...
*Initial STA report showing setup violations, slack calculations, and path delays*
...
*Critical timing path showing cell and net delays contributing to worst slack*
...
*Slack improvements after replacing weaker cells with higher-drive versions*
...
```bash
write_verilog /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/runs/31-10_05-39/results/synthesis/picorv32a.synthesis.v
```
...
```bash
magic -T sky130A.tech \
  lef read /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/runs/31-10_05-39/results/routing/merged_unpadded.lef \
  def read /home/desktop/VLSI/openlane_working_dir/openlane/designs/picorv32a/runs/31-10_05-39/results/routing/picorv32a.def &
```
