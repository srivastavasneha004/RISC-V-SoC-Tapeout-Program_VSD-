...
|---|-------------|--------|----------|
| 1️⃣ | **Floorplan View** | ✅ Complete | [Floorplan](#5-floorplan) |
| 2️⃣ | **Placement View** | ✅ Complete | [Placement](#6-placement) |
| 3️⃣ | **Routed Design** | ✅ Complete | [Routing](#8-routing) |
| 4️⃣ | **SPEF Generation** | ✅ Complete | [SPEF](#9-post-route-spef-generation) |
| 5️⃣ | **Documentation** | ✅ Complete | This README |
| 6️⃣ | **Verification** | ✅ Complete | [Results](#-results-summary) |
...
```bash
https://github.com/srivastavasneha004/RISC-V-SoC-Tapeout-Program_VSD-/blob/main/Week5/README.md
```
...
```mermaid
graph TD
    A[📁 Setup Directories] --> B[📄 Organize Files]
    B --> C[⚙️ Configure Design]
    C --> D[🔧 Synthesis]
    D --> E[📐 Floorplan]
    E --> F[📍 Placement]
...
### 1️⃣ Directory Structure Setup

#### Create Design Directories

```bash
cd /home/user/OpenROAD-flow-scripts/flow
...
```bash
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/module/vsdbabysoc.v designs/src/vsdbabysoc/
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/module/rvmyth.v designs/src/vsdbabysoc/
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/module/clk_gate.v designs/src/vsdbabysoc/
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/module/rvmyth_gen.v designs/src/vsdbabysoc/
```

**Copy analog macro blackbox files:**
```bash
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/module/avsddac.v designs/src/vsdbabysoc/
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/module/avsdpll.v designs/src/vsdbabysoc/
```
...
cp -r /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/gds designs/sky130hd/vsdbabysoc/

# Copy LEF (physical abstracts)
cp -r /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/lef designs/sky130hd/vsdbabysoc/

# Copy LIB (timing libraries)
cp -r /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/lib designs/sky130hd/vsdbabysoc/

# Copy include files (Verilog headers)
cp -r /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/include designs/sky130hd/vsdbabysoc/
```

> ⚠️ **IMPORTANT:** Remove duplicate standard cell library
> ```bash
...
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/sdc/vsdbabysoc_synthesis.sdc \
   designs/sky130hd/vsdbabysoc/

# Copy macro placement file
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/layout_conf/vsdbabysoc/macro.cfg \
   designs/sky130hd/vsdbabysoc/

# Copy pin order file
cp /home/user/OpenROAD-flow-scripts/VSDBabySoC/src/layout_conf/vsdbabysoc/pin_order.cfg \
   designs/sky130hd/vsdbabysoc/
```
...
### 9️⃣ Post-Route SPEF Generation
